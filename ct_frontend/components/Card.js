...
export default function Card({ item, index, buttonVariants }) {
  ...
  return (
    <motion.div
      key={index}
      className=" transition duration-300 ease-in-out hover:scale-110 p-5 px-6 rounded-2xl border-offWhite border-opacity-20 border-[1px] my-4 h-full flex flex-col justify-between"
      initial={{
        opacity: 0,
