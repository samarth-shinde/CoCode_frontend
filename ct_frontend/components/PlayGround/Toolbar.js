...
export default function ToolBar({
  ...
  const { tooltipshow, setTooltipshow } = useContext(ToolStateContext);
    ...
    <div className="">
      <div className=" bg-[#1c1c28] flex justify-between px-3 md:px-14 py-3 items-center text-white w-full">
        ...
        <div className="flex items-center relative">
          ...
          <button
            className="mx-0.5 md:mx-2 cursor-pointer p-1 text-white"
            onClick={() => {
        ...
        <div className="flex items-center relative">
          ...
          {toggle && (
            <div className={"absolute top-10 z-10  bg-black p-5 rounded-md"}>
