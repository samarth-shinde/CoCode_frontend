...
import CodeEditorImg from "../public/images/giphy.gif";
      ...
      <div className="w-full min-h-screen text-white bg-[#1C1C28]">
        ...
        <div className="flex justify-center mt-28 md:mt-52 mb-5 text-center">
          <h3 className="text-4xl md:text-5xl font-medium">
            What does <span className="font-semibold italic">CoCode</span> do?
          </h3>
        </div>
        ...
        <div className="mb-3 flex justify-center">
          <Image src={CodeEditorImg} priority="false" />
        </div>

        {/* footer */}
        <div className="pb-6 flex justify-center">
          <span className="text-1xl">Made with ❤️ @surat</span>
        </div>
      </div>
    </>
  );
