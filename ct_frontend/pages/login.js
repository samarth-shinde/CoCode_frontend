    ...
    if (username == "") {
      ...
      axios
        ...
        .then((resp) => {
          ...
          axios
            .post(`${config.getUserDetailsURL}`, {
              token: resp,
            })
            .then((res) => {
              console.log(res.data.username);
              setCookieUsername("username", res.data.username, {
        ...
        .catch((err) => {
          if (err?.response?.status === 400) {
            setTypeAlert("error");
            setAlert("The crediationals provided were invalid");
      ...
      >
        <div>
          ...
          <p className="text-center text-md mt-3 text-white">
            ...
            <Link href="/register">
              <a className=" text-blue-500 hover:text-blue-700 mx-1">
                Register
              </a>
            </Link>
          </p>
